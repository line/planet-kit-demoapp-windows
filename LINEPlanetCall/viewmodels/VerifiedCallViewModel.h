...
#include "VerifiedCallViewModel.g.h"

namespace winrt::LINEPlanetCall::implementation {
    struct VerifiedCallViewModel : VerifiedCallViewModelT<VerifiedCallViewModel> {
        VerifiedCallViewModel(LINEPlanetCall::CallService callService);
        virtual ~VerifiedCallViewModel();
...
namespace winrt::LINEPlanetCall::factory_implementation {
    struct VerifiedCallViewModel : VerifiedCallViewModelT<VerifiedCallViewModel, implementation::VerifiedCallViewModel> {
