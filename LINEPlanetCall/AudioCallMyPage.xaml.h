...
#include "AudioCallMyPage.g.h"

namespace winrt::LINEPlanetCall::implementation
{
    struct AudioCallMyPage : AudioCallMyPageT<AudioCallMyPage>
    {
        AudioCallMyPage()
        {
...
{
    struct AudioCallMyPage : AudioCallMyPageT<AudioCallMyPage, implementation::AudioCallMyPage>
    {
    };
}
