...
#include "CallScenarioPage.g.h"

namespace winrt::LINEPlanetCall::implementation
{
    struct CallScenarioPage : CallScenarioPageT<CallScenarioPage>
    {
        CallScenarioPage()
        {
...
{
    struct CallScenarioPage : CallScenarioPageT<CallScenarioPage, implementation::CallScenarioPage>
    {
    };
}
