...
namespace winrt::LINEPlanetCall::implementation {
    ...
    private:
        ...
        hstring m_serviceId = L"line-planet-call-beta";
        hstring m_serverUrl = L"https://voipnx-as.line-apps-beta.com";
        hstring m_saturnServerUrl = L"https://voipnx-saturn.line-apps-beta.com";
    };
};
