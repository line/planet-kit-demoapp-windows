...
#include "AudioCallPeerPage.g.h"

namespace winrt::LINEPlanetCall::implementation
{
    struct AudioCallPeerPage : AudioCallPeerPageT<AudioCallPeerPage>
    {
        AudioCallPeerPage()
        {
...
{
    struct AudioCallPeerPage : AudioCallPeerPageT<AudioCallPeerPage, implementation::AudioCallPeerPage>
    {
    };
}
