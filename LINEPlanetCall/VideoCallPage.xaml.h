...
#include "VideoCallPage.g.h"

namespace winrt::LINEPlanetCall::implementation
{
    struct VideoCallPage : VideoCallPageT<VideoCallPage>
    {
        VideoCallPage()
        {
...
{
    struct VideoCallPage : VideoCallPageT<VideoCallPage, implementation::VideoCallPage>
    {
    };
}
